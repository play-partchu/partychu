...
// TEMP: 소셜 로그인 테스트용.
// 아래 CI 해시에 한해서 동일 본인이 여러 UID에서 본인확인 가능.
const TEST_MULTI_ACCOUNT_CI_HASHES = new Set([
  '89e15dbcb6bd38cf37161c49eb01a4056e004d285fd639309ead9b127a70c6f0',
]);
...
async function linkIdentityAndSaveVerification(db, { uid, ci, userPatch, provider }) {
  ...
  const allowMultiAccount = TEST_MULTI_ACCOUNT_CI_HASHES.has(hash);
