  ...
  group('getPartyCoverMedia', () {
    test('테스트1: 사진 1장 + 동영상 1개, 사진을 대표로 선택', () {
      final party = <String, dynamic>{
        ...
        'videoUid': 'abc123',
        'videoThumbnailUrl': 'https://videodelivery.net/abc123/thumbnails/thumbnail.jpg',
      ...
      print('[TEST1] type=${cover.type} imageUrl=${cover.imageUrl} '
    ...
    test('테스트2: 사진 1장 + 동영상 1개, 동영상을 대표로 선택', () {
      final party = <String, dynamic>{
        ...
        'coverThumbnailUrl': 'https://videodelivery.net/abc123/thumbnails/thumbnail.jpg',
      };
      ...
      expect(cover.videoUrl, 'https://videodelivery.net/abc123/manifest/video.m3u8');
      expect(cover.videoUid, 'abc123');
      expect(cover.thumbnailUrl, 'https://videodelivery.net/abc123/thumbnails/thumbnail.jpg');
      print('[TEST2] type=${cover.type} videoUrl=${cover.videoUrl} '
    ...
    test('하위호환: coverMediaType 없고 이미지+동영상 둘 다 있는 기존 데이터 → 이미지 우선', () {
      final party = <String, dynamic>{
        ...
        'videoThumbnailUrl': 'https://videodelivery.net/legacy/thumbnails/thumbnail.jpg',
    ...
    test('하위호환: coverMediaType 없고 동영상만 있는 기존 데이터 → 동영상이 대표(기존 isVideoOnly 유지)', () {
      final party = <String, dynamic>{
        'title': '레거시 영상전용 파티',
        'videoUrl': 'https://videodelivery.net/legacy/manifest/video.m3u8',
        'videoUid': 'legacy',
      ...
      expect(cover, isNotNull);
      expect(cover!.type, 'video');
      expect(cover.videoUrl, 'https://videodelivery.net/legacy/manifest/video.m3u8');
    });
  });
}
