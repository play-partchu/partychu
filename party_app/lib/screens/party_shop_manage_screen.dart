    ...
    return Scaffold(
                ...
                children: [
                  ...
                  TextButton.icon(
                    onPressed: () => Navigator.push(
                      context,
                      webFramedRoute(
                        (_) => PartyShopProductRegisterScreen(
                          shopId: shopId,
                          shopName: name,
                        ),
                      ),
              ...
              return SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildBuilderDelegate((_, i) {
                    ...
                    // 🛠 주문제작 — 재고를 세지 않는 상품이라 '품절'로 읽히면
                    // 안 된다(빨간 글씨로 팔 수 없는 것처럼 보인다).
                    final madeToOrder = isMadeToOrderProduct(d);
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => Navigator.push(
          ...
          webFramedRoute(
            (_) =>
                PartyShopProductRegisterScreen(shopId: shopId, shopName: name),
          ),
        ),
        backgroundColor: const Color(0xFFFF6FA0),
        foregroundColor: Colors.white,
