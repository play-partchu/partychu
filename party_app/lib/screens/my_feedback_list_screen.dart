              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('아직 보낸 의견이 없어요',
                        style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.black54)),
                    const SizedBox(height: 8),
                    Text('앱 개선을 위한 의견을 자유롭게 남겨주세요.',
            ...
            Row(children: [
              Container(
                ...
                child: Text(FeedbackType.label(item.type),
                    style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: Color(0xFFFF6FA0))),
              ),
              const Spacer(),
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
        ...
        child: ListView(
          ...
          children: [
            ...
            Row(children: [
              ...
              Text(FeedbackStatus.label(item.status),
            ...
            const SizedBox(height: 12),
            Text(item.content, style: const TextStyle(fontSize: 14, height: 1.6)),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, i) => Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.network(item.imageUrls[i], width: 90, height: 90, fit: BoxFit.cover),
                    ),
                  ),
                ),
              ),
                ...
                child: Column(
                  ...
                  children: [
                    const Row(children: [
                      ...
                      SizedBox(width: 6),
                      Text('파티츄 답변',
                          style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Color(0xFFFF6FA0))),
                    ]),
                    const SizedBox(height: 8),
                    Text(item.userReply, style: const TextStyle(fontSize: 14, height: 1.6)),
                  ],
                ),
              ),
            ],
