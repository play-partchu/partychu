...
class ShopDetailSearchSheet extends StatefulWidget {
  ...
  final ValueChanged<ShopFilter>? onFilterReset;

  const ShopDetailSearchSheet({
    super.key,
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _multiChipGroup(
                    '가격 범위',
                    ListingConstants.shopPriceRanges,
                    _draft.priceRanges,
                  ),
                  ...
                  _switchRow(
                    '배송 가능',
                    _draft.deliveryAvailable,
                    (v) => setState(() => _draft.deliveryAvailable = v),
                  ),
                  _switchRow(
                    '방문 수령 가능',
                    _draft.pickupAvailable,
